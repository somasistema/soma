      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            o botão em Dados do orçamento complementar. Pra Lavratura, Registro, Prenotação (x2) e
            Certidão entrarem sozinhos junto com o serviço, configure o pacote em Configurações
            &gt; Pacotes.
          </p>
