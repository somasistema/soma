  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="flex items-center gap-2 font-serif-doc text-2xl font-semibold text-foreground">
        ...
        Taxas e Emolumentos — Tabelas de Custas
      </h1>
      <p className="text-sm text-muted-foreground">
        Tabelas oficiais de custas do TJBA (Decreto Judiciário nº 1075/2025, vigência
        01/01/2026) — usadas nos boletos avulsos, na calculadora por faixa e nos Pacotes
        automáticos do orçamento.
      </p>
      <BoletosTabs />
      {children}
    </div>
